...
## CLAs (2)
## 1 - REQUIRED - File extension without leading dot or star for last 20 regardless of extension.
...
## Write the recent files to a text file by looping through the entries of mru_key and initialize RecentFile objects.
file_handle = open("recent_files.log", "w+")

for entry in mru_key.list_of_entries:
	file_handle.write(str(fileHistory.RecentFile(entry).getRecentFile()) + "\n")
